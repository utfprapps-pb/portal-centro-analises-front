                          ...
                          h.newStatus == 'PENDING_PAYMENT' ? '#d49f00' :
                            h.newStatus == 'APPROVED' ? '#d49f00' :
                              h.newStatus == 'PENDING_CORRECTION' ? '#e93946' :
                                h.newStatus == 'REFUSED' ? '#ff0000' :
                                  '#000000'}
                  width="160px"
                  letterSpacing="0px"
                  fontSize="12px"
                  fontWeight="300" /></TableCell>
                <TableCell scope="row">{(new Date(h.changeDate)).toLocaleString()}</TableCell>
                  ...
                  {(authenticatedUser &&
                    ...
                    <>
                      <RejectionReasonButtonView
                        visible={true}
                        color={'#ff0000'}
                        rejectionReason={h.solicitation?.rejectionReason ?? ''} />
                        ...
                        <TableBody>
                          {historyItens?.map((i: SolicitationAudit) => (
                            <TableRow key={i.id}>
                              ...
                              <TableCell scope="row">{(new Date(i.changeDate)).toLocaleString()}</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
